...
class AllFlatsPage:
    ...
    def ad_links(self):
        ...
        items_adv = get_soup_elements(self.soup, locator_adv)
        ...
        items = get_soup_elements(self.soup, locator)
    ...
    def page_count(self):
        ...
        page_num_list = [int(item.text) for item in get_soup_elements(self.soup, locator)]
